				...
				<div class="row mb-2">
					...
					<div class="col-md-6" style="width: 33%;">
						<div
							...
							<input class="form-control me-2" type="text" name="aprice"
					...
					<div class="col-md-6" style="width: 33%;">
						<div
							...
							<input class="form-control me-2" type="text" name="rnum"
					...
					<div class="col-md-6" style="width: 33%;">
						<div
							...
							<input class="form-control me-2" type="text" name="tnum"
								size="60" placeholder="The number of Room"
								style="margin-bottom: 11%;">
						</div>
					</div>
					<div class="col-md-6" style="width: 33%;">
						<div
							...
							<input class="form-control me-2" type="text" name="bnum"
								size="60" placeholder="The number of Room"
								style="margin-bottom: 11%;">
						</div>
					</div>
